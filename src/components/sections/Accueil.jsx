      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
        ...
        <div>
          ...
          <a
            href={cvFile}
            download
            className="inline-flex items-center px-6 py-3 border-2 border-teal-600 dark:border-teal-400 text-teal-600 dark:text-teal-400 font-medium rounded-lg hover:bg-teal-600/10 dark:hover:bg-teal-400/10 transition-all duration-200"
          >
            ...
            <svg
              ...
              viewBox="0 0 24 24"
            >
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 16v4h16v-4M12 12v8m0 0l-4-4m4 4l4-4" />
            </svg>
          </a>
        </div>
